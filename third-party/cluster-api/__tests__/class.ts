...
import { Cluster } from "../gen/cluster.x-k8s.io/v1beta2/Cluster";
import { Machine } from "../gen/cluster.x-k8s.io/v1beta2/Machine";
import { MachineDeployment } from "../gen/cluster.x-k8s.io/v1beta2/MachineDeployment";
import { ClusterResourceSet } from "../gen/addons.cluster.x-k8s.io/v1beta2/ClusterResourceSet";
import { IPAddressClaim } from "../gen/ipam.cluster.x-k8s.io/v1beta2/IPAddressClaim";
import { ExtensionConfig } from "../gen/runtime.cluster.x-k8s.io/v1beta2/ExtensionConfig";
